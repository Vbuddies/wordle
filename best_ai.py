...
def makeguess(wordlist, guesses=[], feedback=[]):
	...
	"""
	if(len(guesses) == 0):
		return random.choice(["REAIS", "SLATE", "AEGIS", "LARES", "RALES", "TARES", "NARES", "ARLES", "SIREN", "RAISE", "QUERY", "RENTS", "SNARE", "EARNS", "STOAE", "SANER", "CANOE", "TEARS", "STEAM", "ADIEU", "SOARE", "AROSE"])
